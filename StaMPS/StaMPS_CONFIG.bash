export STAMPS="/Users/daleroberts/Work/StaMPS-4.1-beta"
export SNAPHU_BIN="/Users/daleroberts/Work/snaphu-v2.0.6"
...
export PATH=${PATH}:/Applications/MATLAB_R2023a.app/bin/:$STAMPS/bin:$MY_SCR:$INT_BIN:$INT_SCR:$OUR_SCR:$DORIS_SCR:$GETORB_BIN:$DORIS_BIN:$TRIANGLE_BIN:$SNAPHU_BIN
